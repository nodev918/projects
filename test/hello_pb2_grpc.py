...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Test = channel.unary_unary(
                '/hello.Greeter/Test',
                request_serializer=hello__pb2.TestRequest.SerializeToString,
                response_deserializer=hello__pb2.TestReply.FromString,
                )
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Test': grpc.unary_unary_rpc_method_handler(
                    servicer.Test,
                    request_deserializer=hello__pb2.TestRequest.FromString,
                    response_serializer=hello__pb2.TestReply.SerializeToString,
            ),
    }
...
class Greeter(object):
    ...
    def Test(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/hello.Greeter/Test',
            hello__pb2.TestRequest.SerializeToString,
            hello__pb2.TestReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
